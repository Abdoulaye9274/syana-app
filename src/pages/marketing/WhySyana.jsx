        ...
        <div className="min-h-screen bg-bg-primary font-sans text-white">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-40 pb-24">
                ...
                <div className="prose prose-invert prose-lg mx-auto leading-relaxed text-text-secondary">
                    ...
                    <h3 className="text-white mt-12 mb-4">Le problème de l'information infinie</h3>
                    <p>
                    ...
                    <p>
                        Le problème, ce n'est plus l'accès à la connaissance. <strong className="text-white">C'est l'ordre d'exécution.</strong>
                    </p>
                    <p>
                    ...
                    <h3 className="text-white mt-12 mb-4">La réponse : Une structure rigide pour une créativité libre</h3>
                    <p>
                    ...
                    <div className="bg-white/5 border-l-4 border-cyan p-6 my-10 rounded-r-lg not-prose">
                    ...
                    <h3 className="text-white mt-8 mb-4">Notre promesse</h3>
                ...
                <div className="mt-16 pt-8 border-t border-white/5 flex items-center gap-4">
                    ...
                    <div>
                        <p className="font-bold text-white">L'équipe Syana</p>
